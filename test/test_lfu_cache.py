...
class TestLRUCache(unittest.TestCase):
    ...
    def test_overflow_identical_timestamp_and_frequencies(self):
        ...
        self.assertEqual(first=3, second=len(cache.cache), msg="There should be 3 items in the cache")
        cache._cache_strategy.evict(cache=cache)
        self.assertEqual(first=2, second=len(cache.cache), msg="There should be 2 items in the cache after evicting the last one")
